...
def build():
    ...
    L.append("# 12. Editor's Notes — work still needed")
    L.append("")
    ...
    L.append("## 12.1 Architectural decisions required")
    L.append("")
    L.append("The following questions are unresolved. Each blocks one or more of the items in clause "
             "12.2, and they are listed first because the drafting that follows depends on them.")
    L.append("")
    ...
    L.append("## 12.2 Outstanding items")
    L.append("")
    sub = 0
    ...
    if absent:
        ...
        L.append("## 12.3 Normative material not yet drafted")
        L.append("")
