...
DECISIONS = {
 ...
 "D13": ("Location of authority: role credentials or DID Documents",
         "The architect has proposed that ADI-ROLE Verifiable Credentials be removed and that each entity's role, "
         "entitlements and assurance ceilings be carried in its DID Document, signed by the enrolling authority as DID "
         "controller. The chain of trust is unchanged; the artefact carrying it changes. It simplifies enrollment and "
         "unifies key and authority lookup, at the cost of making DID resolution a dependency of every verification. "
         "A complete design is held by the editors and can be applied once the working group confirms the direction. "
