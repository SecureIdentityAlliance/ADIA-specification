...
Nobody moves their own work to `Verified`. For the 68 automated defects the harness does it; for the other 39 a second person does.
...
19 defects · 2 verified · 8 with an automated check
