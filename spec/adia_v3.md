...
```json
{
  ...
  "batch_credential_endpoint": "https://issuer1.ix1.adi.example/batch_credential",
  "deferred_credential_endpoint": "https://issuer1.ix1.adi.example/deferred_credential",
