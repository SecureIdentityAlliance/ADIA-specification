...
# 12. Editor's Notes — work still needed
...
| Awaiting an architectural decision | 23 |
| Open decisions | 11 |
...
## 12.1 Architectural decisions required

The following questions are unresolved. Each blocks one or more of the items in clause 12.2, and they are listed first because the drafting that follows depends on them.
...
## 12.2 Outstanding items

<a id="editors-notes-normative"></a>
### 12.2.1 Normative structure and conformance
...
### 12.2.2 Cryptography and protocol
...
### 12.2.4 Architecture and terminology
...
### 12.2.5 References, figures and tooling
...
## 12.3 Normative material not yet drafted
