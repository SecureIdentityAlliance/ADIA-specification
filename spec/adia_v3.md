...
| | |
|---|---|
| Items outstanding | 48 |
| Of which critical | 10 |
| Awaiting an architectural decision | 20 |
| Open decisions | 12 |
...
Decided 22 September 2026. ADI-ROLE Verifiable Credentials are retained. They are issued by the onboarding Interchange for Credential Issuers, Service Providers and Users; the ADI Global Domain issues only the Interchange's own credential and approves and lists Issuers in the network directory. This is the design the draft already describes. An alternative carrying authority in the DID Document was considered and not adopted. One point remains for the Study Group: whether a verifier's check of the Issuer's entitlement is mandatory, as the draft states, or discretionary.
